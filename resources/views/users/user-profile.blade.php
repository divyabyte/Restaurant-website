...
<html lang="en">
  ...
  <body>
    ...
    <div class="mt-5">
      ...
      <hr>     
        <p class="text-uppercase text-center">{{ Auth::user()->name }} </p>
        <p class="text-uppercase text-center">{{ Auth::user()->email }} </p>
        <p class="text-uppercase text-center">{{ Auth::user()->phone }} </p>
    </div>
