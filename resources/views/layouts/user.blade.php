...
<html lang="en">
  ...
  <body>
    ...
    <div class="modal-body">
      <div class="btn-group">
        <button type="button" class="btn btn-primary btn-white-outline dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Select Location
        </button>
          ...
          <div class="container">
            <div class="row slider-text align-items-center justify-content-center">
              <div class="col-md-8 text-center col-sm-12 ">
                ...
                <button type="button" data-aos="fade-up" data-aos-delay="200" class="btn btn-primary btn-outline-white" data-toggle="modal" data-target="#exampleModal">
                Get Started 
                </button>
              </div>
            </div>
    ...
    <section class="section bg-light py-5  bottom-slant-gray ">
      ...
      <div class="container mt-5">
        <div class="row">
          ...
          <img src="{{url('assets/img/menu.png ')}}" height="150px" width="150px">
